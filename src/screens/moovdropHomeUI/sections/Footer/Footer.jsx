...
export const Footer = () => {
  return (
    <footer className="relative w-full bg-moovdrop-dark py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="font-dm-sans font-normal text-white/80 text-sm leading-relaxed max-w-md">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-dm-sans font-bold text-white text-base mb-4">Quick Links</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="font-dm-sans font-normal text-white/70 text-sm hover:text-white transition-colors">
                  Rent a Vehicle
                </a>
              </li>
              <li>
          ...
          {/* Support */}
          <div>
            <h3 className="font-dm-sans font-bold text-white text-base mb-4">Support</h3>
            <ul className="space-y-3">
              <li>
                <a href="#" className="font-dm-sans font-normal text-white/70 text-sm hover:text-white transition-colors">
                  Help Center
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="font-dm-sans font-normal text-white/60 text-sm">
